        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h1 class="text-xl font-semibold text-gray-800">Medical Record Details</h1>
            ...
            <div class="px-6 py-4 space-y-4">
                ...
                <div class="border-b border-gray-200 pb-4">
                    ...
                    <p class="text-gray-900 text-base whitespace-pre-line">
                ...
                <div class="pb-4">
                    ...
                    <p class="text-gray-900 text-base">
                        {{ \Carbon\Carbon::parse($medicalRecord->date)->format('d M Y - H:i A') }}
                    </p>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                <div class="flex justify-end space-x-3">
                    ...
                    <a href="{{ route('medical_records.edit', $medicalRecord) }}" 
                    ...
                    <form action="{{ route('medical_records.destroy', $medicalRecord) }}" 
                          method="POST" 
                          class="inline-block"
